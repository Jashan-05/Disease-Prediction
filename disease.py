...
# TESTING DATA df -------------------------------------------------------------------------------------
df=pd.read_csv("C:\\Users\\saksh\\Downloads\\Testing.csv")
...
# TRAINING DATA tr --------------------------------------------------------------------------------
tr=pd.read_csv("C:\\Users\\saksh\\Downloads\\Training.csv")
...
w2 = Label(root, justify=LEFT, text="A Project by Saksham Pandit and Jassi Lassi", fg="black", bg="white")
